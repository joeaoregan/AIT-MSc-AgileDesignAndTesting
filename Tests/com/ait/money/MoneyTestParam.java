...
public class MoneyTestParam {
	...
	private static final Object[] getAmountsNotEqual() {
		return $($(10, 20, "USD"), $(15, 20, "EUR"), $(10, 15, "GBP"));
	}

	@Parameters
	private static final Object[] getCurrencyNotEqual() {
		return $($(10, "EUR", "USD"), $(20, "EUR", "GBP"), $(15, "GBP", "USD"));
	}

	// This shows that it is possible to send objects as parameters but not really
	// needed.
	@Parameters
	private static final Object[] getObjects() {
		return $($(new Car()), $(new Cat()), $(new Dog()));
	}
